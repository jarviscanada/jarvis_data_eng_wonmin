...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Create a trader and a account",
            notes = "TraderId and AccountId are auto generated by the database, and they should be identical. Assume each trader has exactly one account")
    ...
    public TraderAccountView createTrader(@PathVariable String firstname, @PathVariable String lastname,
                                          @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dob, @PathVariable String country,
    ...
    @ApiOperation(value = "Delete a trader", notes = "Delete a trader IFF its account amount is 0 and not open positions" +
    ...
    @ApiOperation(value = "Withdraw a fund", notes = "With a fund from the account that associates with the given traderId")
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "traderId is not found"),
